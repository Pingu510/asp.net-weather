...
namespace Arbetsprov.CSharp.Web.Services
{
	public class WeatherService : IWeatherService
	{
		...
		// används av test tills vidare, DI setup fail
		public WeatherService()
		{

			PrepHttpClient(baseUrlstring: "https://api.met.no/weatherapi/locationforecast/2.0/compact");
		}

		private void PrepHttpClient(string baseUrlstring = "")
		{
			var baseUrl = string.IsNullOrEmpty(baseUrlstring) ? _configuration.GetValue<string>("Settings:WeatherForecastURL") : baseUrlstring;
